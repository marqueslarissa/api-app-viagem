# Generated by Django 3.0.7 on 2020-07-05 22:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Cliente',
            fields=[
                ('id_cliente', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Hotel',
            fields=[
                ('id_quarto', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Reserva',
            fields=[
                ('id_reserva', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Voo',
            fields=[
                ('id_voo', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('preco_unitario', models.DecimalField(decimal_places=2, max_digits=10)),
                ('preco_total', models.DecimalField(decimal_places=2, max_digits=10)),
