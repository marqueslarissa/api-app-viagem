# Generated by Django 3.0.7 on 2020-07-06 03:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pacote', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Reserva')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.AddConstraint(
            model_name='hotel',
            constraint=models.UniqueConstraint(fields=('id', 'pacote'), name='hotel_reserva_constraint'),
        ),
    ]
